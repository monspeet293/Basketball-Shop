	...
	<div class="well well-small">
		...
		<c:if test="${ ProductsPaginate.size() > 0  }">
						...
						<li class="span4">
							<div class="thumbnail">
								<a href="product_details.html" class="overlay"></a> <a
									...
									</a> <a href="<c:url value="/product-details/${item.id }"/>"><img
         ...
         maxFractionDigits = "3" value = " ${item.price }" /> </strong>
									...
									<h4>
										<a class="btn btn-primary" href="<c:url value="/AddCart/${item.id }"/>" title="add to cart"> Buy It </a>
									</h4>
									<div class="actionList">
										<a class="pull-left" href="#"> </a> <a
